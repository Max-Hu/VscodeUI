...
test("getPanelHtml renders required controls and message contract", () => {
  ...
  assert.match(html, /id="copilotModel"/);
  ...
  assert.match(html, /type: "load-pr-diff-files"/);
  ...
  assert.match(html, /pr-diff-files-loaded/);
  assert.match(html, /pr-diff-opened/);
  assert.match(html, /pr-diff-failed/);
  assert.match(html, /Load PR Files To Tree/);
  assert.match(html, /PR Diff Files/);
  assert.match(html, /copilot-models/);
  assert.match(html, /list-copilot-models/);
  assert.match(html, /copilotModelId/);

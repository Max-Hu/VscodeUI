export function trimPullRequestFiles(files, maxFiles, maxPatchCharsPerFile) {
...
export function extractConfluenceLinks(textChunks) {
...
export function collectKeywords(textChunks, explicitKeywords) {
